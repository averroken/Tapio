...
import be.howest.nmct.tapio.service.TapioService;
...
public class AddLandmarkActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = (ImageView) findViewById(R.id.AddLandmarkImage);
        mContext = this;
...
//                    imageView.setImageDrawable(drawable);
                    ...
                    int height = 0;
                    Picasso.with(this)
                            .load(Uri.parse(data.getDataString()))
...
// TODO Auto-generated catch block
    ...
    private void addLandmark(final View view) {
        ...
        Account account = LoginActivity.mAccountManager.getAccountsByType(Contract.ACCOUNT_TYPE)[0];
        String token = LoginActivity.mAccountManager.peekAuthToken(account, Contract.AUTH_TYPE);

        Call<LandmarkPostResponse> call = service.addLandmark(token, body);String test = "lol";
